...
#     store = Store(
#         name='file-store',
#         connector=FileConnector(store_dir=str(cfg.output_dir / 'proxy-store')), # noqa: E501
#     )
...
#     # Define the parsl configuration (this can be done using the config_factory # noqa: E501
