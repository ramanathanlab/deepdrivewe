...
from deepdrivewe.examples.synd_ntl9_lof.inference import InferenceConfig
from deepdrivewe.examples.synd_ntl9_lof.inference import run_inference
...
if __name__ == '__main__':
    ...
    doer = ParslTaskServer(
        [
            (my_run_simulation, {'executor': 'cpu_htex'}),
            (my_run_inference, {'executor': 'gpu_htex'}),
        ],
        queues,
        parsl_config,
    )
